...
public class CrabModel <T extends CrabEntity> extends HierarchicalModel<T> {
    ...
    public CrabModel(ModelPart body) {
        this.body = body;
    }

    public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(MobVote2023.MOD_ID,"crab"),"main");
    ...
    @Override
    public void setupAnim(CrabEntity entity, float f, float g, float h, float i, float j) {
