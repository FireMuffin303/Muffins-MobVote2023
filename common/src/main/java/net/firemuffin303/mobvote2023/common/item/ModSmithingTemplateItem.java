...
public class ModSmithingTemplateItem extends SmithingTemplateItem {
    ...
    static{
        TURTLE_UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(MobVote2023.MOD_ID,"smithing_template.turtle_upgrade.applies_to"))).withStyle(ChatFormatting.BLUE);
        TURTLE_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(MobVote2023.MOD_ID,"smithing_template.turtle_upgrade.ingredients"))).withStyle(ChatFormatting.BLUE);
        TURTLE_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(MobVote2023.MOD_ID,"smithing_template.turtle_upgrade.base_slot_description")));
        TURTLE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(MobVote2023.MOD_ID,"smithing_template.turtle_upgrade.additions_slot_description")));
        TURTLE_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", new ResourceLocation(MobVote2023.MOD_ID,"turtle_upgrade"))).withStyle(ChatFormatting.GRAY);
        EMPTY_SLOT_ARMADILLO = new ResourceLocation(MobVote2023.MOD_ID,"item/empty_slot_armadillo");
        EMPTY_SLOT_SCUTE = new ResourceLocation(MobVote2023.MOD_ID,"item/empty_slot_scute");
